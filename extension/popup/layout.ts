...
export const EXTENSION_CONNECT_APPROVAL_BASE_WIDTH = EXTENSION_POPUP_BASE_WIDTH;
export const EXTENSION_CONNECT_APPROVAL_BASE_MIN_HEIGHT = EXTENSION_POPUP_BASE_MIN_HEIGHT;
